...
def camera2():
    ...
    # Configure camera for preview with lower resolution
    config = picam2.create_preview_configuration(
...
if __name__ == "__main__": # init app
    ...
    # In order to use sessions you have to set a secret key for encryption purposes
    # as a user could hack into the contents of a cookie and modify if there was no secret key used for signing the cookies.
